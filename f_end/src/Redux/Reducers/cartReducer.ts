...
export const actions = {
    ...
    IsFetchingAC: (isFetching: boolean) => ({ type: 'cart/IS_FETCHING', payload: isFetching } as const),
}
...
export const SubmitCart = (form: { name: string; phone: string; }, address: string, items: ProductsType[], total: number): ThunkType => {
    return async (dispatch: DispatchType) => {
